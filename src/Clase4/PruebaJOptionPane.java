...
class OptionDialogFrame extends JFrame {
	...
	public Object[] getOptions() {
		...
		if (s.equals("String[]"))
			...
			return new Icon[] { new ImageIcon("src/circuloAmarillo.png"), new ImageIcon("src/circuloAzul.png"),
					new ImageIcon("src/circuloRojo.png") };
		else if (s.equals("Object[]"))
			return new Object[] { messageString, messageIcon, messageComponent, messageObject };
		else
			return null;
	...
	private Icon messageIcon = new ImageIcon("src/circuloAzul.png");
